...
namespace Sokol
{
    ...
    public class SkyboxRenderer
    {
        ...
        public void Render(GltfViewerNameSpace.Camera camera, EnvironmentMap environmentMap, int width, int height, float exposure, int tonemapType, bool useOffscreenPipeline = false)
        {
            if (!is_initialized)
                return;
