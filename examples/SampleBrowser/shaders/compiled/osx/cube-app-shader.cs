...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/cube-app.glsl --reflection --output shaders/compiled/osx/cube-app-shader.cs --slang metal_macos -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static int cube_attr_slot(string attr_name) {
    ...
    public static int cube_texture_slot(string tex_name) {
        return -1;
    }
    public static int cube_sampler_slot(string smp_name) {
        return -1;
    }
    public static int cube_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int cube_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int cube_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform cube_uniform_desc(string ub_name, string u_name) {
    ...
    public static int cube_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int cube_storageimage_slot(string simg_name) {
        return -1;
    }
}
