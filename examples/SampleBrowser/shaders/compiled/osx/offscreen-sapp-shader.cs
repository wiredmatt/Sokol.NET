...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/offscreen-sapp.glsl --reflection --output shaders/compiled/osx/offscreen-sapp-shader.cs --slang metal_macos -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static int default_attr_slot(string attr_name) {
    ...
    public static int default_texture_slot(string tex_name) {
        if (tex_name == "tex") {
            return 0;
        }
        return -1;
    }
    public static int default_sampler_slot(string smp_name) {
        if (smp_name == "smp") {
            return 0;
        }
        return -1;
    }
    public static int default_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int default_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int default_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform default_uniform_desc(string ub_name, string u_name) {
    ...
    public static int default_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int default_storageimage_slot(string simg_name) {
        return -1;
    }
    public static int offscreen_attr_slot(string attr_name) {
        if (attr_name == "position") {
            return 0;
        }
        if (attr_name == "normal") {
    ...
    public static int offscreen_texture_slot(string tex_name) {
        return -1;
    }
    public static int offscreen_sampler_slot(string smp_name) {
        return -1;
    }
    public static int offscreen_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int offscreen_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int offscreen_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform offscreen_uniform_desc(string ub_name, string u_name) {
        sg_glsl_shader_uniform res = default;
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                res.type = SG_UNIFORMTYPE_MAT4;
    ...
    public static int offscreen_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int offscreen_storageimage_slot(string simg_name) {
        return -1;
    }
}
