...
namespace loadpng_sapp_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/loadpng-sapp.glsl --reflection --output shaders/compiled/osx/loadpng-sapp-shader.cs --slang metal_macos -f sokol_csharp
        ...
        Bindings:
            ...
            Sampler 'smp':
                ...
                Bind slot: SMP_smp => 0
    */
    public const int ATTR_loadpng_pos = 0;
    public const int ATTR_loadpng_texcoord0 = 1;
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static unsafe sg_shader_desc loadpng_shader_desc(sg_backend backend) {
    ...
    public static int loadpng_attr_slot(string attr_name) {
        if (attr_name == "pos") {
            return 0;
        }
    ...
    public static int loadpng_texture_slot(string tex_name) {
        if (tex_name == "tex") {
            return 0;
        }
        return -1;
    }
    public static int loadpng_sampler_slot(string smp_name) {
        if (smp_name == "smp") {
            return 0;
        }
        return -1;
    }
    public static int loadpng_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int loadpng_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int loadpng_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform loadpng_uniform_desc(string ub_name, string u_name) {
    ...
    public static int loadpng_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int loadpng_storageimage_slot(string simg_name) {
        return -1;
    }
}
