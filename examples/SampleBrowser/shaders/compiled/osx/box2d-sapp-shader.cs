...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/box2d-sapp.glsl --reflection --output shaders/compiled/osx/box2d-sapp-shader.cs --slang metal_macos -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static int box2d_attr_slot(string attr_name) {
    ...
    public static int box2d_texture_slot(string tex_name) {
        return -1;
    }
    public static int box2d_sampler_slot(string smp_name) {
        return -1;
    }
    public static int box2d_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int box2d_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int box2d_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform box2d_uniform_desc(string ub_name, string u_name) {
    ...
    public static int box2d_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int box2d_storageimage_slot(string simg_name) {
        return -1;
    }
}
