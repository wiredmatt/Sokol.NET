...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/cubemap-jpeg-sapp.glsl --reflection --output shaders/compiled/osx/cubemap-jpeg-sapp-shader.cs --slang metal_macos -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    static readonly byte[] vs_source_metal_macos = {
            ...
            0x74,    0x0a,    0x7b,    0x0a,    0x20,    0x20,    0x20,    0x20,    0x66,    0x6c,    0x6f,    0x61,    0x74,    0x33,    0x20,    0x75,    
            0x76,    0x77,    0x20,    0x5b,    0x5b,    0x75,    0x73,    0x65,    0x72,    0x28,    0x6c,    0x6f,    0x63,    0x6e,    0x30,    0x29,    
            ...
            0x20,    0x20,    0x6f,    0x75,    0x74,    0x2e,    0x75,    0x76,    0x77,    0x20,    0x3d,    0x20,    0x66,    0x61,    0x73,    0x74,    
            0x3a,    0x3a,    0x6e,    0x6f,    0x72,    0x6d,    0x61,    0x6c,    0x69,    0x7a,    0x65,    0x28,    0x69,    0x6e,    0x2e,    0x70,    
            0x6f,    0x73,    0x2e,    0x78,    0x79,    0x7a,    0x29,    0x3b,    0x0a,    0x20,    0x20,    0x20,    0x20,    0x72,    0x65,    0x74,    
    ...
    */
    static readonly byte[] fs_source_metal_macos = {
            ...
            0x75,    0x76,    0x77,    0x20,    0x5b,    0x5b,    0x75,    0x73,    0x65,    0x72,    0x28,    0x6c,    0x6f,    0x63,    0x6e,    0x30,    
            ...
            0x2e,    0x75,    0x76,    0x77,    0x29,    0x3b,    0x0a,    0x20,    0x20,    0x20,    0x20,    0x72,    0x65,    0x74,    0x75,    0x72,    
    ...
    public static int cubemap_attr_slot(string attr_name) {
        if (attr_name == "pos") {
            return 0;
        }
        return -1;
    }
    public static int cubemap_texture_slot(string tex_name) {
        if (tex_name == "tex") {
            return 0;
        }
        return -1;
    }
    public static int cubemap_sampler_slot(string smp_name) {
        if (smp_name == "smp") {
            return 0;
        }
        return -1;
    }
    public static int cubemap_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int cubemap_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int cubemap_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform cubemap_uniform_desc(string ub_name, string u_name) {
    ...
    public static int cubemap_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int cubemap_storageimage_slot(string simg_name) {
        return -1;
    }
}
