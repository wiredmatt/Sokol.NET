...
namespace dyntex_sapp_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/dyntex-sapp.glsl --reflection --output shaders/compiled/osx/dyntex-sapp-shader.cs --slang metal_macos -f sokol_csharp
        ...
        Bindings:
            ...
            Sampler 'smp':
                ...
                Bind slot: SMP_smp => 0
    */
    public const int ATTR_dyntex_position = 0;
    public const int ATTR_dyntex_color0 = 1;
    public const int ATTR_dyntex_texcoord0 = 2;
...
[StructLayout(LayoutKind.Sequential)]
    ...
    */
    ...
    public static unsafe sg_shader_desc dyntex_shader_desc(sg_backend backend) {
        if (backend == SG_BACKEND_METAL_MACOS) {
            ...
            desc.label = "dyntex_shader";
            return desc;
        }
        return default(sg_shader_desc);
    }
    public static int dyntex_attr_slot(string attr_name) {
    ...
    public static int dyntex_texture_slot(string tex_name) {
        if (tex_name == "tex") {
            return 0;
        }
        return -1;
    }
    public static int dyntex_sampler_slot(string smp_name) {
        if (smp_name == "smp") {
            return 0;
        }
        return -1;
    }
    public static int dyntex_uniformblock_slot(string ub_name) {
        if (ub_name == "vs_params") {
            return 0;
        }
        return -1;
    }
    public static int dyntex_uniformblock_size(string ub_name) {
        if (ub_name == "vs_params") {
            return Marshal.SizeOf<vs_params_t>();
        }
        return 0;
    }
    public static int dyntex_uniform_offset(string ub_name, string u_name) {
        if (ub_name == "vs_params") {
            if (u_name == "mvp") {
                return 0;
            }
    ...
    public static sg_glsl_shader_uniform dyntex_uniform_desc(string ub_name, string u_name) {
    ...
    public static int dyntex_storagebuffer_slot(string sbuf_name) {
        return -1;
    }
    public static int dyntex_storageimage_slot(string simg_name) {
        return -1;
    }
}
