...
namespace nanosvg_demo_shader_cs {
...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/nanosvg-demo.glsl --output shaders/compiled/osx/nanosvg-demo-shader.cs --slang metal_macos -f sokol_csharp

        Overview:
        =========
        Shader program: 'nanosvg':
            Get shader desc: nanosvg_shader_desc(sg_query_backend());
            Vertex Shader: vs
            Fragment Shader: fs
            Attributes:
                ATTR_nanosvg_pos => 0
        ...
        Bindings:
            ...
            Sampler 'smp':
                ...
                Bind slot: SMP_smp => 0
    */
    public const int ATTR_nanosvg_pos = 0;
    public const int ATTR_nanosvg_uv0 = 1;
...
[StructLayout(LayoutKind.Sequential)]
    public struct vs_params_t {
        public vs_params_t(){}
        public fixed float quad_xform[4];
    };
    /*
        ...
        {
            main0_out out = {};
            out.gl_Position = float4(in.pos.x * _25.quad_xform.x, in.pos.y * _25.quad_xform.y, 0.0, 1.0);
            out.uv = in.uv0;
            return out;
        }
    ...
    */
    static readonly byte[] vs_source_metal_macos = {
            ...
            0x6c,    0x6f,    0x61,    0x74,    0x34,    0x20,    0x71,    0x75,    0x61,    0x64,    0x5f,    0x78,    0x66,    0x6f,    0x72,    0x6d,    
            ...
            0x20,    0x66,    0x6c,    0x6f,    0x61,    0x74,    0x34,    0x28,    0x69,    0x6e,    0x2e,    0x70,    0x6f,    0x73,    0x2e,    0x78,    
            0x20,    0x2a,    0x20,    0x5f,    0x32,    0x35,    0x2e,    0x71,    0x75,    0x61,    0x64,    0x5f,    0x78,    0x66,    0x6f,    0x72,    
            0x6d,    0x2e,    0x78,    0x2c,    0x20,    0x69,    0x6e,    0x2e,    0x70,    0x6f,    0x73,    0x2e,    0x79,    0x20,    0x2a,    0x20,    
            0x5f,    0x32,    0x35,    0x2e,    0x71,    0x75,    0x61,    0x64,    0x5f,    0x78,    0x66,    0x6f,    0x72,    0x6d,    0x2e,    0x79,    
            0x2c,    0x20,    0x30,    0x2e,    0x30,    0x2c,    0x20,    0x31,    0x2e,    0x30,    0x29,    0x3b,    0x0a,    0x20,    0x20,    0x20,    
            0x20,    0x6f,    0x75,    0x74,    0x2e,    0x75,    0x76,    0x20,    0x3d,    0x20,    0x69,    0x6e,    0x2e,    0x75,    0x76,    0x30,    
    ...
    */
    ...
    public static unsafe sg_shader_desc nanosvg_shader_desc(sg_backend backend) {
