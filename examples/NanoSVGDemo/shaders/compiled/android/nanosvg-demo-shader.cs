...
public static unsafe class Shaders 
{
    /*
        ...
        Cmdline:
            sokol-shdc --input shaders/nanosvg-demo.glsl --output shaders/compiled/android/nanosvg-demo-shader.cs --slang glsl300es -f sokol_csharp
...
[StructLayout(LayoutKind.Sequential)]
    ...
    /*
        ...
        void main()
        {
            gl_Position = vec4(pos.x * vs_params[0].x, pos.y * vs_params[0].y, 0.0, 1.0);
            uv = uv0;
        }
    ...
    */
    static readonly byte[] vs_source_glsl300es = {
            ...
            0x63,    0x34,    0x28,    0x70,    0x6f,    0x73,    0x2e,    0x78,    0x20,    0x2a,    0x20,    0x76,    0x73,    0x5f,    0x70,    0x61,    
            0x72,    0x61,    0x6d,    0x73,    0x5b,    0x30,    0x5d,    0x2e,    0x78,    0x2c,    0x20,    0x70,    0x6f,    0x73,    0x2e,    0x79,    
            ...
            0x20,    0x20,    0x75,    0x76,    0x20,    0x3d,    0x20,    0x75,    0x76,    0x30,    0x3b,    0x0a,    0x7d,    0x0a,    0x0a,    0x00,    
